...
TEXT_REWARD_ARGS=(--grpo_text_reward_mode entailment --grpo_text_nli_model_path "$ENTAILMENT_MODEL_PATH" --grpo_text_nli_device "${ENTAILMENT_DEVICE:-cuda}" --grpo_text_nli_batch_size "${ENTAILMENT_BATCH_SIZE:-32}")
