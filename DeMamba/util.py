...
def build_model(model_name, neuron_indices_path=None, xclip_model_path=None,
                dinov3_repo_path=None, dinov3_weights_path=None, dinov3_model_name=None,
                dinov3_backend=None, dinov3_hf_model_path=None, dinov2_hf_model_path=None):
    ...
    if model_name == 'DINOv3_NeuronDeMamba_4':
        ...
        return models.DINOv3_NeuronDeMamba(
            neuron_indices_path=neuron_indices_path,
    ...
    if model_name == 'DINOv2_NeuronDeMamba_4':
        if not neuron_indices_path:
            raise ValueError("DINOv2_NeuronDeMamba_4 requires cfg['neuron_indices_path']")
        if not dinov2_hf_model_path:
            raise ValueError("DINOv2_NeuronDeMamba_4 requires cfg['dinov2_hf_model_path']")
        return models.DINOv2_NeuronDeMamba(
            neuron_indices_path=neuron_indices_path,
